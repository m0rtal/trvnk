...
function genLlmsIndex() {
  ...
  const lines = [
    ...
    "## Структура каталога",
    "",
    "Каждая карточка растения (`/plants/<slug>/`) содержит:",
    "",
    "1. Краткую сводку (таблица: тип, высота, семейство, ареал, морозостойкость и др.)",
    "2. Галерею фотографий",
    "3. Полное описание (таксономия, морфология, ареал, условия выращивания, размножение, статус охраны)",
    "4. Структурированные данные JSON-LD по Schema.org (Plant + Article)",
    "",
