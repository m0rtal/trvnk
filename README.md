...
Русскоязычный статический каталог растений из открытой базы **Plants For A Future** (PFAF).

- **Стек:** [Astro](https://astro.build) (статика), без бэкенда и БД.
- **Источник данных:** [pfaf.org](https://pfaf.org) (парсинг → markdown).
...
Код — MIT. Данные — атрибуция PFAF. Изображения — права принадлежат PFAF и авторам.